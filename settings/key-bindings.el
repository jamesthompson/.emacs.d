...
(global-set-key (kbd "C-S-c M-a") 'mc/mark-all-dwim)
(global-set-key (kbd "C-S-c M-d") 'mc/mark-next-like-this)
(global-set-key (kbd "C-S-c M-r") 'mc/mark-all-in-region)
...
(global-set-key (kbd "C-x C-o hl") (ffip-create-pattern-file-finder "*.hs"))
(global-set-key (kbd "C-x C-o ps") (ffip-create-pattern-file-finder "*.purs"))
(global-set-key (kbd "C-x C-o ag") (ffip-create-pattern-file-finder "*.agda"))
(global-set-key (kbd "C-x C-o ca") (ffip-create-pattern-file-finder "*.cabal"))
