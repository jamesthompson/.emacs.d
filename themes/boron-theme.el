...
(custom-theme-set-faces
 ...
 ;; Temporary defaults
 '(linum                               ((t (:foreground "#888888"  :background "#2a2a28" ))))
...
;; Keywords and language syntaxn
 '(font-lock-comment-face ((t (:foreground "#888888"  ))))
 '(font-lock-string-face ((t (:foreground "#d54a42"  ))))
 '(font-lock-variable-name-face ((t (:foreground "#ffb964"  ))))
 '(font-lock-type-face ((t (:foreground "#7aa6db"  ))))
 '(font-lock-function-name-face ((t (:foreground "#99ad6a"  ))))
 `(font-lock-keyword-face ((t (:foreground "#ffb964"))))
