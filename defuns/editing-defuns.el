...
(defun normalize-mdhq-column-headings ()
  "Normalizes MD-HQ column headings from their raw data dumps"
  (interactive)
  (goto-char 1)
  ...
  (while (search-forward ":" nil t) (replace-match "" nil t))
  (goto-char 1)
  (while (search-forward "%" nil t) (replace-match "pc" nil t))
  (goto-char 1)
  (while (search-forward "." nil t) (replace-match "dot" nil t)))
